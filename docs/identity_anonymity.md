...
[![Privacy](https://img.shields.io/badge/Identity-Management-brightgreen.svg)](https://en.wikipedia.org/wiki/Identity_management)
...
4. [🏷️ Metadata & Digital Footprints](#metadata--digital-footprints)
5. [🌐 Anonymizing Networks](#anonymizing-networks)
6. [🖥️ Browser & Device Fingerprinting](#browser--device-fingerprinting)
7. [✅ Operational Security Checklists](#operational-security-checklists)
8. [⚠️ Common Pitfalls & Real-World Cases](#common-pitfalls--real-world-cases)
...
| **⚙️ Operation** | Stick to the persona’s defined boundaries. Never break compartmentation. |
...
- ☁️ **Separate cloud storage** – One Drive/Dropbox account per persona, never cross‑logged‑in.
...
- ✍️ **Language & writing style** – Change vocabulary, punctuation, and even typical typos between personas.

---

## 🏷️ Metadata & Digital Footprints
...
| ✉️ Email headers | Sender IP, client, routing hops | Use webmail over Tor, or remailers |
...
- 🗑️ **Clear state** – Regularly delete cookies, local storage, browser cache, and history. Even better – use ephemeral browser profiles (e.g., `firefox -CreateProfile`, then delete after closing).
...
- [ ] 🕵️ Never log into the persona’s accounts from an unmasked device.
- [ ] 🔁 Regularly rotate user‑agents and circuits (in Tor: `New Identity`).

### ✔️ When retiring a persona

- [ ] 🗑️ Delete all online accounts (follow each platform’s deletion procedure).
...
## ⚠️ Common Pitfalls & Real-World Cases
...
- **🖥️ Panopticlick by EFF** – Test your browser fingerprint: [https://panopticlick.eff.org](https://panopticlick.eff.org)
- **📄 “Anonymity Loves Company: Usability and the Network Effect”** (academic paper)
- **🛡️ EFF’s Surveillance Self‑Defense** – [https://ssd.eff.org](https://ssd.eff.org)
